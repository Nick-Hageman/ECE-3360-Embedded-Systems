...
function simulateEnterKeyPress() {
    ...
    let event = new KeyboardEvent("keydown", {
        key: "Enter",          // Name of the key
        code: "Enter",         // Key code
        keyCode: 13,           // Numeric value of the Enter key
...
// Check if running in Node.js and export the function if true
...
function updateGame(input) {
	...
	if (input.size == 1) {
		...
		// Call the function to simulate the key press
